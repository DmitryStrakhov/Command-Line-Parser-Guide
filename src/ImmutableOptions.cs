...
public class ImmutableOptions {
    ...
    class Options {
        public Options(int integerOption, bool booleanOption, IEnumerable<string>? enumerableOption, string? value1, string? value2) {
            Value1 = value1;
            Value2 = value2;
            IntegerOption = integerOption;
            BooleanOption = booleanOption;
            EnumerableOption = enumerableOption;
        }
        
        [Option(shortName: 'i', longName: "int", HelpText = "Integer Option Help")]
        public int IntegerOption { get; }
        ...
        public IEnumerable<string>? EnumerableOption { get; }
